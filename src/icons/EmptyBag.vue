<template>
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 100 100">
    <path class="text-gray-50" fill="currentColor" d="M0 0h100v100H0z" />
    <path class="text-gray-200" fill="currentColor" d="M47.058 36.105a1.5 1.5 0 00-1.283-.028l-6.855 3.064 14.793 7.397L61 43.076l-13.94-6.97z" />
    <path
      class="text-gray-800"
      fill="currentColor"
      fill-rule="evenodd"
